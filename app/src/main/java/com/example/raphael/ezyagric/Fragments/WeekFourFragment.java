...
public class WeekFourFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_week_four, container, false);
...
//                startActivity(l);
    ...
    public void getInsurance() {
        try {
            ...
            final LocalDate startOfWeek = new LocalDate(input.minusWeeks(3).withDayOfWeek(DateTimeConstants.MONDAY));

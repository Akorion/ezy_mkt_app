...
/**
 * Created by Raphael on 9/26/2017.
 */


public class PostProduceAdapter extends RecyclerView.Adapter<PostProduceAdapter.MyViewHolder> {
    private Context mContext;
    private ArrayList<JsonObject> albumList;


    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView FirstName, LastName, from, subject, message, iconText, Timestamp;
    ...
    public PostProduceAdapter(Context mContext, ArrayList<JsonObject> albumList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.post_produce_list, parent, false);
...
//        .inflate(R.layout.sell_produce_card, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        try {
            ...
            holder.message.setText("Variety: " + ins.get("crop").getAsString());

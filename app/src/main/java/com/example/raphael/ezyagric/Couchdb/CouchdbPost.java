...
/**
 * Created by Raphael on 9/25/2017.
 */

public class CouchdbPost {
    private static final String TAG = "BUY";
    private static final String DOC_TYPE = "buy_produce_feedback";
    private static final String VIEW_NAME = "posted_orders";

    private Context CONTEXT = null;
    private static CouchdbManager couchdbManager;

    public CouchdbPost(Context c) {
        CONTEXT = c;

 ...
 */
public class CouchdbBuyProduce {
    private static final String TAG = "BUY";
    private static final String DOC_TYPE = "buy_produce";
    private static final String VIEW_NAME = "posted _orders";

    private Context CONTEXT = null;
    private static CouchdbManager couchdbManager;

    public CouchdbBuyProduce(Context c) {
        CONTEXT = c;
...
//                farmers.add(this.propToJSON(row.getDocument().getProperties()));
    ...
    public static boolean addSells(JSONObject test) {
        boolean result = true;
